    ...
    return (
        <div className="product">
            ...
            <div className="product_info">
                <p className="info_name">productName</p>
                <p className="info_description">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptas necessitatibus nihil a labore laborum ad saepe aperiam. Quia repudiandae, facere iusto illo repellat ad esse non, error omnis ipsa repellendus?
                </p>
